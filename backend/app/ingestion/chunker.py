...
class DocumentChunker:
    ...
    def chunk_text(
        ...
        if not document_id:
            raise ValueError("source_metadata.document_id must be assigned before chunking.")
        ...
        user_id = _get_attr(source_metadata, "user_id")
        subject = _get_attr(source_metadata, "subject")
        language = _get_attr(source_metadata, "language")
        source_type = _get_attr(source_metadata, "source_type")
        ...
        while start < text_length:
            ...
            if chunk_text:
                ...
                chunk_id = self._build_chunk_id(document_id, chunk_index)
