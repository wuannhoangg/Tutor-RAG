...
def classify_query_with_reason(
    ...
    if loop and loop.is_running():
        return loop.create_task(classify_query_with_reason_async(query, context, user_config))
    else:
        return asyncio.run(classify_query_with_reason_async(query, context, user_config))
...
def classify_query(
    ...
    result = classify_query_with_reason(query=query, context=context, user_config=user_config)
