...
class User(Base):
    """Represents a system or human user."""
    __tablename__ = "users"
...
class Answer(Base):
    ...
    query_id = Column(Integer, index=True, nullable=True)
    user_id = Column(String(128), index=True, nullable=True)
...
class Citation(Base):
    ...
    document_id = Column(String(128), index=True, nullable=True)
    chunk_id = Column(String(128), index=True, nullable=True)
    page_start = Column(Integer, nullable=True)
    page_end = Column(Integer, nullable=True)
