...
def generate_plan_steps(
    ...
    if loop and loop.is_running():
        return loop.create_task(generate_plan_steps_async(goal, context, user_api_key))
    else:
        return asyncio.run(generate_plan_steps_async(goal, context, user_api_key))
...
def generate_plan(goal: str, context: Optional[str] = None, user_api_key: Optional[str] = None) -> str:
    result = generate_plan_steps(goal=goal, context=context, user_api_key=user_api_key)
